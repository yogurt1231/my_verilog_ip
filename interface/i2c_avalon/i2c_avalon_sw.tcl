...
create_driver i2c_avalon_driver

# Associate it with some hardware
set_sw_property hw_class_name i2c_avalon
...
# C/C++ source files
add_sw_property c_source HAL/src/i2c_avalon_driver.c

# Include files
add_sw_property include_source HAL/inc/i2c_avalon_driver.h
